...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
        <!-- Google Tag Manager -->
        <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-W8X6TB"
        height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
        j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
        '//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        })(window,document,'script','dataLayer','GTM-W8X6TB');</script>
        <!-- End Google Tag Manager -->

        <div id="outdated"></div>


        <header id="mcmaster-header" class="light-grey">  <!-- class options: dark-grey, light-grey, light-slate, dark-slate, black, maroon
        <!--   Search Overlay  -->
        ...
        <!--    McMaster Menu -->
            <ul id="mcmaster-nav" class="open" role="navigation">
                ...
                <li><h3 tabindex="0">Discover McMaster</h3>
                    <ul>
                ...
                <li><h3 tabindex="0">Future Students</h3>
                    <ul>
                ...
                <li><h3 tabindex="0">Current Students</h3>
                    <ul>
...
<!--        Search Overlay-->
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-btn">
                      <button class="btn btn-info btn-lg" type="submit">
                          <svg id="seach-icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.3 17.3"><path class="search-icon" d="M12.9 11.8l.3-.4c.8-1.2 1.3-2.6 1.3-4.1 0-1-.2-1.9-.6-2.8-.4-.9-.9-1.7-1.5-2.3C11.8 1.6 11 1 10.1.7 8.3-.1 6.3-.1 4.5.7c-1 .2-1.7.8-2.4 1.4C1.5 2.8.9 3.5.6 4.4.2 5.3 0 6.3 0 7.2c0 1 .2 1.9.6 2.8.4.9.9 1.7 1.5 2.3.6.6 1.4 1.2 2.3 1.5.9.4 1.8.6 2.8.6 1.5 0 2.9-.4 4.1-1.3l.4-.3 4.2 4.2c.3.3.8.3 1.1 0 .2-.2.2-.3.2-.6 0-.2-.1-.4-.2-.6l-4.1-4zm-1.7-.6c-1.1 1.1-2.4 1.7-4 1.7-1.5 0-2.9-.6-4-1.7s-1.7-2.4-1.7-4c0-1.5.6-2.9 1.7-4s2.4-1.7 4-1.7c1.5 0 2.9.6 4 1.7s1.7 2.4 1.7 4-.6 2.9-1.7 4z"/></svg>
    <span class="sr-only">Search</span>
          ...
          <div id="mcmaster-quick-links">
            <div class="link-row">
              <div class="column">
                ...
                <ul class="list-unstyled">
                  <li><a href="http://www.mcmaster.ca/opr/html/a_z/main/a_z_index.html">A-Z Campus Index</a>
                  </li>
                  <li><a href="http://registrar.mcmaster.ca/askmcmaster/">Ask McMaster</a>
                  </li>
                  <li><a href="http://future.mcmaster.ca/tours/virtual/">Virtual Tour</a>
                  </li>
                  <li><a href="http://www.mcmaster.ca/welcome/findus.cfm">How to get to McMaster</a>
                  </li>
                  <li><a href="http://telecom.mcmaster.ca/directory.cfm">Faculty and Staff Directory</a>
                  </li>
                  <li><a href="http://mosaic.mcmaster.ca/">Mosaic</a>
                  </li>
                </ul>
              </div>
              <div class="column">
                ...
                <ul class="list-unstyled">
                  <li><a href="http://www.degroote.mcmaster.ca/">DeGroote School of Business</a>
                  </li>
                  <li><a href="http://www.eng.mcmaster.ca/">Faculty of Engineering</a>
                  </li>
                  <li><a href="http://fhs.mcmaster.ca/">Faculty of Health Sciences</a>
                  </li>
                  <li><a href="http://www.humanities.mcmaster.ca/">Faculty of Humanities</a>
                  </li>
                  <li><a href="http://www.science.mcmaster.ca/">Faculty of Science</a>
                  </li>
                  <li><a href="https://socialsciences.mcmaster.ca/">Faculty of Social Sciences</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="link-row">
              <div class="column">
                ...
                <ul class="list-unstyled">
                  <li><a href="http://registrar.mcmaster.ca/">Current Students</a>
                  </li>
                  <li><a href="http://future.mcmaster.ca/">Future Students</a>
                  </li>
                  <li><a href="http://oia.mcmaster.ca/portal/">International Students</a>
                  </li>
                  <li><a href="http://studentsuccess.mcmaster.ca">Student Success Centre</a>
                  </li>
                  <li><a href="http://future.mcmaster.ca/programs/viewbook/">McMaster Viewbook</a>
                  </li>
                  <li><a href="https://www.mcmastercce.ca/">Centre for Continuing Education</a>
                  </li>
                </ul>
              </div>
              <div class="column">
                ...
                <ul class="list-unstyled">
                  <li><a href="http://alumni.mcmaster.ca/">Alumni</a>
                  </li>
                  <li><a href="http://www.marauders.ca/">Athletics</a>
                  </li>
                  <li><a href="http://library.mcmaster.ca/">Libraries</a>
                  </li>
                  <li><a href="http://mosaic.mcmaster.ca">Mosaic</a>
                  </li>
                  <li><a href="http://research.mcmaster.ca/">Research</a>
                  </li>
                  <li><a href="http://alumni.os.mcmaster.ca/s/1439/index.aspx?sid=1439&gid=1&pgid=323">Give to McMaster</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <script>
          (function() {
            var cx = '017110053273856412988:akq6v26t6nm';
